...
To: nettime-l
Subject: <nettime> usenet faq and a rant about handedness
From: t byfield
Date: [Tue, 13 Apr 1999 13:42:45 -0400](https://nettime.org/Lists-Archives/nettime-l-9904/msg00230.html)

`a short but interesting FAQ on the early history of usenet` 
`(‘USENET: The Great Renaming, 1985-1988’) by Lee Bumgarner:`

`<http://www.vrx.net/usenet/history/rename.html> \[*dead link*]`
...
`you think that’s a joke, try reading this:`
 ...
 `:renragmuB eeL yb (‘8891-5891 ,gnimaneR taerG ehT :TENESU’)`
    ...
    `<lmth.emaner/yrotsih/tenesu/ten.xrv.www//:ptth>`
