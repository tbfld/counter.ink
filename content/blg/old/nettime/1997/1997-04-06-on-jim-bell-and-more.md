...
To: nettime-l
Subject: <nettime> when’s net.discourse not.net.discourse?
From: t byfield
Date: [Sun, 6 Apr 1997 14:10:27 -0500](https://nettime.org/Lists-Archives/nettime-l-9704/msg00011.html)

Not the usual nettime fare, but...

Several months ago, I posted a series of notes to nettime questioning how worthwhile the very idea/phrase “net discourse” really is, and asking *what* it is. For example, like the distinction held on news.admin.net.abuse.* school between “abuse *on* the net” and “abuse *of* the net,” is “net discourse” something written on the net or something written about the net? or both? is it critical approaches transplanted to the net? a culmination of certain theoretical traditions in one of the above-mentioned things?
