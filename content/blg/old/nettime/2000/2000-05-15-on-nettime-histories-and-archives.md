...
To: nettime-l
Subject: Re: <nettime> Re: (protocol) Re: Histories
From: t byfield
Date: [Mon, 15 May 2000 01:31:54 -0400](https://nettime.org/Lists-Archives/nettime-l-0005/msg00124.html)

T. Whid (Sun 05/14/00 at 02:15 PM -0400):

> could the administrators of these lists post some comments on their long-term plans for archival of the texts? how many back-ups are on how many servers? are there foundations with a mission to preserve them? if not, perhaps rhizome, thing, nettime could create one, or band together to lobby for international funding for one?
...
`(k�ln); another (i�m not sure how complete) at tao.ca, in`
