...
) The way to put an end to this kind of stuff is, more than just firing these monsters (no “resignations,” please), revoking their pensions. But how exactly would you specify what’s so wrong about this? It’s not an idle question at all — abusively threatening to use state power is a plague, maybe *the* plague in this country.
