---
yaml_begin: true
title: 2026-02-11-the mycology to epidemiology to media theory to public policy pipeline
description: death by social media
extract: Native speakers of Ukrainian, Mixtec, and Mandarin all make the same mycological mistake at the same time
created: 2026-02-11 08:02
updated: 2026-02-11 08:02
author: tb
images: false
order:
enableToc: true
...
[Bruno Latour](https://en.wikipedia.org/wiki/Bruno_Latour) opened his book *We Have Never Been Modern* with a remarkable passage that gestures at a certain kind of conceptual chaos that permeates “media”:
...
warehouses *literally* full of GPUs
are springing up like mushrooms after a hot summer rain
...
Decades ago, when *Financial Times* was my daily, I was fortunate to tune in to a basic distinction in their global coverage — between the *rules-based* approach to accounting of US-style accounting and the *principles-based* approach that more and more of the world is adopting (Wikipedia [is pretty OK on this](https://en.wikipedia.org/wiki/Accounting_standard)). 
