...
On one level it makes sense, because NCF is in Sarasota. But we know about NCF: it’s the progressive state school that DeSantis demolished by appointing that “**edu pest**” [Christopher Rufo](https://en.wikipedia.org/wiki/Christopher_Rufo) to its BoT. But, in practice, taking Ringling away from FSU doesn’t advance scientific research — what it does is *weaken arts and letters*.
