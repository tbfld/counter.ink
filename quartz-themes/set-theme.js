...
if (!fs.existsSync(path.join(currentFolder, "styles"))) {
  console.error(
...
ensureDirectoryExists(path.join(currentFolder, "styles", "themes"))

// Clear the contents of the quartz/styles/themes directory
clearDirectoryContents(path.join(currentFolder, "styles", "themes"))

ensureDirectoryExists(path.join(currentFolder, "styles", "themes", "overrides"))
...
const themeDest = path.join(currentFolder, "styles", "themes")
